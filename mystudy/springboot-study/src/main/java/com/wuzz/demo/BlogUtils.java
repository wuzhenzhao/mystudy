...
public class BlogUtils {
    ...
    public static String str6 ="https://blog.csdn.net/weixin_41358004/article/details/103995169";
    public static String str7 ="https://blog.csdn.net/weixin_41358004/article/details/103987659";
    public static String str9 ="https://blog.csdn.net/weixin_41358004/article/details/103987655";
    ...
    public static void doAdd() {
        ...
        while (q) {    //一直循环
            try {
                ...
                if (a > 25) {
                    // 启用cmd运行chrome的方式来退出
                    Runtime.getRuntime().exec("taskkill /F /IM iexplore.exe"); //我默认浏览器是 chrome
