package com.wuzz.demo.netty.nio.chat;
...
public class NIOChatClient2 {
	...
	private final InetSocketAddress serverAdrress = new InetSocketAddress("localhost", 8887);
    ...
    public NIOChatClient2() throws IOException{
